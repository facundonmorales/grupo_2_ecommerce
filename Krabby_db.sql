...
CREATE TABLE `product` (
  ...
  CONSTRAINT `id_category` FOREIGN KEY (`id_category`) REFERENCES `category` (`id_category`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id_user`),
  KEY `id_roll_idx` (`roll_id`),
  CONSTRAINT `id_roll` FOREIGN KEY (`roll_id`) REFERENCES `roll_user` (`id_roll`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2022-10-27  0:43:25
